...
if not GEMINI_API_KEY:
    # Fallback to check for GOOGLE_API_KEY
...
def call_ai_service(prompt: str, system_prompt: str, json_response: bool = True, temperature: float = 0.2) -> Dict[str, Any]:
    """
    Make a request to the Google Gemini API with automatic retries for rate limits.
...
from app.api.endpoints import jobs, resumes, search, outreach, automation, referrals
